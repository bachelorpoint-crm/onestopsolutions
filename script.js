...
const CONFIG = {
  ...
  ai: {
    enabled: true, // AI connected through Cloudflare Worker
    endpoint: "https://onestopai.tanvirfarhan06.workers.dev/", // Cloudflare Worker URL
    model: "gpt-5.6-luna", // Model used by the Cloudflare Worker
    headers: {
